...
--
	...
	if menu_in_game then		
		print("🅾️ resume ",(111*8)+40,245,7)
	else					
		print("🅾️ restart",p.x+25,245,7)
	end
		//111*8,128
		
	if not menu_in_game then
		print("⬅️",111*8+52,128+118,g)
		print("⬆️",111*8+60,128+115,up)
		print("⬇️",111*8+60,128+122,dn)
		print("➡️",111*8+68,128+118,d)
	end					
...
--						cam_y+20,7)
		...
		print("🅾️",cam_x+2,cam_y+2,7)
		print(current_time(game_timer),
									cam_x+11,
									cam_y+2)
									
		spr(p.sp,p.x,p.y,1,1,p.flp)
		print("⬅️",cam_x+50,cam_y+122,g)
		print("❎",cam_x+60,cam_y+122,xx)
		print("➡️",cam_x+70,cam_y+122,d)
	end
end
